...
#define NU_KS_IOCTL_READ         _IOWR(MA35H0_KS_MAGIC, 1, \
				       struct ks_read_args *)
#define NU_KS_IOCTL_WRITE_SRAM   _IOWR(MA35H0_KS_MAGIC, 2, \
				       struct ks_write_args *)
#define NU_KS_IOCTL_WRITE_OTP    _IOWR(MA35H0_KS_MAGIC, 3, \
				       struct ks_write_args *)
#define NU_KS_IOCTL_ERASE        _IOWR(MA35H0_KS_MAGIC, 4, \
				       struct ks_kidx_args *)
#define NU_KS_IOCTL_ERASE_ALL    _IOWR(MA35H0_KS_MAGIC, 5, \
				       unsigned long)
#define NU_KS_IOCTL_REVOKE       _IOWR(MA35H0_KS_MAGIC, 6, \
				       struct ks_kidx_args *)
#define NU_KS_IOCTL_GET_REMAIN   _IOWR(MA35H0_KS_MAGIC, 7, \
				       unsigned long)
#define NU_KS_IOCTL_READ_OTP     _IOWR(MA35H0_KS_MAGIC, 11, \
				       struct ks_read_args *)
