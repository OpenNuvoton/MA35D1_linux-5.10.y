...
#if 0
static void ma35h0_check_work(struct work_struct *work)
{
	struct ma35h0_i2c *i2c =
			container_of(work, struct ma35h0_i2c, check_work.work);
	unsigned int tmp;
	...
	ma35h0_i2c_master_complete(i2c, i2c->stop_ret);
}
#endif
...
static int ma35h0_i2c_probe(struct platform_device *pdev)
{
	...
	//INIT_DELAYED_WORK(&i2c->check_work, ma35h0_check_work);
