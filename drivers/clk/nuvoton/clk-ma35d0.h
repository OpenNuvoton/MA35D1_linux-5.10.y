...
#ifndef CLK_NUVOTON_CLK_MA35D0_H
#define CLK_NUVOTON_CLK_MA35D0_H
...
struct clk_hw *ma35d0_reg_clk_pll(enum ma35d0_pll_type type, u8 u8mode,
				 const char *name, const char *parent,
				 unsigned long targetFreq,
				 void __iomem *base,
				 struct regmap *regmap);

struct clk_hw *ma35d0_reg_adc_clkdiv(struct device *dev,
				    const char *name,
...
static inline struct clk_hw *ma35d0_clk_fixed(const char *name, int rate)
{
	return clk_hw_register_fixed_rate(NULL, name, NULL, 0, rate);
}

static inline struct clk_hw *ma35d0_clk_mux(const char *name,
					    void __iomem *reg, u8 shift,
					    u8 width,
...
static inline struct clk_hw *ma35d0_clk_divider(const char *name,
						const char *parent,
						void __iomem *reg, u8 shift,
						u8 width)
{
	return clk_hw_register_divider(NULL, name, parent, CLK_SET_RATE_PARENT,
				       reg, shift, width, 0, &ma35d0_lock);
}

static inline struct clk_hw *ma35d0_clk_divider_pow2(const char *name,
						     const char *parent,
						     void __iomem *reg,
						     u8 shift, u8 width)
{
...
static inline struct clk_hw *ma35d0_clk_divider_table(const char *name,
						      const char *parent,
						      void __iomem *reg,
						      u8 shift, u8 width,
...
static inline struct clk_hw *ma35d0_clk_fixed_factor(const char *name,
						     const char *parent,
						     unsigned int mult,
						     unsigned int div)
{
...
static inline struct clk_hw *ma35d0_clk_gate(const char *name,
					     const char *parent,
					     void __iomem *reg, u8 shift)
{
	return clk_hw_register_gate(NULL, name, parent, CLK_SET_RATE_PARENT,
				    reg, shift, 0, &ma35d0_lock);
}
