 ...
 */
static int ma35d0_tsen_get_temp(void *data, int *temp)
{
	struct ma35d0_tmperature_sensor *sensor = data;
	int reg;
...
static const struct thermal_zone_of_device_ops ma35d0_tz_ops = {
