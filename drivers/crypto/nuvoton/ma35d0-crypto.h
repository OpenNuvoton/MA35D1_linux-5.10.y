 ...
 *
 */
#ifndef __MA35D0_CRYPTO_H__
#define __MA35D0_CRYPTO_H__
...
extern int ma35d0_crypto_optee_init(struct nu_crypto_dev *nu_cryp_dev);

extern int ma35d0_prng_probe(struct device *dev, void __iomem *reg_base, unsigned long *data);
extern int ma35d0_prng_remove(struct device *dev, unsigned long data);

extern int ma35d0_aes_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35d0_aes_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35d0_sha_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35d0_sha_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35d0_ecc_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35d0_ecc_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35d0_rsa_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35d0_rsa_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
